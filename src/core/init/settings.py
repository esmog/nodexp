...
def init():
	...
	# exploitation
	global home_directory, msf_payload, lhost, lport, encoding, payload_path, rc_path, encode, append_top, append_bottom, exploitation_flags, ex_prompt_message, ex_options_message, ex_alter_tech_msg, ex_current_tech_msg, reverse_shell_payload,exploitation_state
